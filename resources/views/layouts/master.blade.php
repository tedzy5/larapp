...
<div class="wrapper" id="app">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ config('app.url') }}" class="brand-link">
            <img src="{{ asset('img/logo.png') }}" alt="{{ config('app.name') }} Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
    ...
    <footer class="main-footer">
        ...
        <div class="float-right d-none d-sm-inline">
            Powered by T.A.M. Clouds
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2014-<?php echo date("Y"); ?> <a href="{{ config('app.url') }}">{{ config('app.name') }}</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
